...
st.write("**Upload an image and let's try to guees if it was generated by AI or if it is a real art**")
...
if uploaded_file is not None:
    ...
    if label == 1:
        st.write("The model prediction is: **Real art (might not be the original painting)** \n\n please share the result with me to improve the model through linkedin: https://www.linkedin.com/in/mohammad-alkhatim-9b1770266/")
    elif label == 0:
